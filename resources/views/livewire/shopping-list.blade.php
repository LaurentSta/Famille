            ...
            <div class="bg-gradient-to-b from-brand-orange to-brand-red rounded-xl shadow-lg p-1 sticky top-4 z-10">
                <div class="bg-white rounded-lg p-2.5 sm:p-4">
                    ...
                    <form wire:submit.prevent="addNewIngredient" class="flex gap-1">
                        ...
                        >
                        <button type="submit" class="shrink-0 px-2.5 rounded-lg bg-brand-red text-white text-sm font-medium">+</button>
                    </form>
                </div>
            </div>
        </aside>
                                    ...
                                    <tr class="border-t border-neutral-100">
                                        ...
                                        <td class="pl-2 pr-4 py-2 w-10 text-right">
                                            <button
                                                ...
                                                class="size-7 rounded-full text-neutral-400 hover:bg-brand-red/10 hover:text-brand-red text-base leading-none"
                                            >×</button>
                                        </td>
                                    </tr>
                                @endforeach
