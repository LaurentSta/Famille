                                            ...
                                            >
                                                @if ($meal?->dish)
                                                    ...
                                                    <button
                                                        ...
                                                        class="cursor-pointer absolute inset-0 rounded-md bg-white/90 flex items-center justify-center text-brand-red opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto [@media(hover:none)]:opacity-100 [@media(hover:none)]:pointer-events-auto transition-opacity"
                                                    >
