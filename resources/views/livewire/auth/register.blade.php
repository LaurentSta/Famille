<div class="min-h-screen flex items-center justify-center px-6 py-12">
    <div class="max-w-sm w-full">
        ...
        <form wire:submit="register" class="bg-white rounded-xl shadow-sm p-6 space-y-4">
            <div>
                <label class="block text-sm font-medium text-neutral-600 mb-1">Prénom</label>
                <input type="text" wire:model="name" class="w-full rounded-lg border-neutral-200 text-sm" autofocus>
            ...
            <div>
                ...
                <input type="email" wire:model="email" class="w-full rounded-lg border-neutral-200 text-sm">
            ...
            <div>
                <label class="block text-sm font-medium text-neutral-600 mb-1">Confirmer le mot de passe</label>
                <input type="password" wire:model="password_confirmation" class="w-full rounded-lg border-neutral-200 text-sm">
            </div>
