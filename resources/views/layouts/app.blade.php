...
<html lang="fr">
    ...
    <body class="antialiased bg-neutral-50 text-neutral-900">
        <a
            href="https://github.com/LaurentSta/Famille"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Voir le code source sur GitHub"
            class="fixed top-[calc(env(safe-area-inset-top)+0.75rem)] right-[calc(env(safe-area-inset-right)+0.75rem)] z-40 text-neutral-900/20 hover:text-neutral-900/60 transition-colors"
        >
